...
"""
================================================================================
Visit Tunisia — Scraper Tataouine (FINAL — 20 spots de qualité)
================================================================================
Combine OSM + fallback manuel de spots touristiques réels du gouvernorat de Tataouine.
Exclut Médenine, Gabès, Kébili, Gafsa et le reste du pays.
================================================================================
"""
...
# BBOX du gouvernorat de Tataouine (Sud-Est, frontière libyenne)
# Nord: 33.30 (Bir Lahmar), Sud: 31.70 (frontière Libye)
# Ouest: 9.80, Est: 11.10 (Grand Erg Oriental / frontière)
BBOX = {
    "s": 31.70,
    "w": 9.80,
    "n": 33.30,
...
LAT_MIN, LAT_MAX = 31.65, 33.35
LON_MIN, LON_MAX = 9.75, 11.15
...
CITY_BLACKLIST = [
    ...
    "medenine", "مدنين", "jerba", "جربة", "houmt souk", "حومة السوق",
    "gabes", "قابس", "kebili", "قبلي", "ariana", "أريانة",
    "ben arous", "بن عروس", "manouba", "منوبة", "radès", "رادس",
    "ezzahra", "الزهراء", "mornag", "المرناقية"
]
...
# -----------------------------------------------------------------------------
# FALLBACK MANUEL — Spots touristiques réels de Tataouine
# -----------------------------------------------------------------------------

MANUAL_SPOTS = [
    # Ksour & Villages berbères (CULTUREL / AVENTURE)
    ("Ksar Ouled Soltane", "SITE_TOURISTIQUE", ["CULTUREL"], 32.7880, 10.2980,
     "Le Ksar Ouled Soltane est un magnifique grenier fortifié du XVIIe siècle avec ses ghorfas empilées, classé au patrimoine mondial de l'UNESCO.", "castle"),
    ("Chenini", "SITE_TOURISTIQUE", ["CULTUREL", "AVENTURE"], 32.9180, 10.2680,
     "Chenini est un village berbère troglodyte perché sur une crête, célèbre pour ses maisons creusées dans la roche et sa mosquée des Sept Dormants.", "attraction"),
    ("Douiret", "SITE_TOURISTIQUE", ["CULTUREL", "AVENTURE"], 32.9833, 10.4167,
     "Douiret est un ancien village berbère abandonné sur une montagne, offrant une architecture troglodyte unique et des vues panoramiques.", "attraction"),
    ("Ksar Hadada", "SITE_TOURISTIQUE", ["CULTUREL"], 33.1000, 10.3167,
     "Le Ksar Hadada est un grenier fortifié devenu célèbre après le tournage de Star Wars Épisode I dans ses ghorfas.", "castle"),
    ("Ksar Beni Barka", "SITE_TOURISTIQUE", ["CULTUREL"], 32.9500, 10.3500,
     "Le Ksar Beni Barka est considéré comme le plus grand ksar du Maghreb, avec plus de 400 ghorfas encore utilisées par les nomades.", "castle"),
    ("Guermessa", "SITE_TOURISTIQUE", ["CULTUREL", "AVENTURE"], 32.8500, 10.2500,
     "Guermessa est un village berbère troglodyte perché sur un piton rocheux, offrant un paysage lunaire spectaculaire.", "attraction"),
    ("Ksar Ouled Debbab", "SITE_TOURISTIQUE", ["CULTUREL"], 32.8800, 10.3200,
     "Le Ksar Ouled Debbab est un grenier fortifié typique du Dahar, témoignant de l'ingéniosité architecturale des populations du désert.", "castle"),
    ("Ghomrassen", "SITE_TOURISTIQUE", ["CULTUREL"], 33.0500, 10.3333,
     "Ghomrassen est un village historique du Dahar connu pour son ksar, ses grottes habitées et son festival international des ksour.", "attraction"),
    
    # Tataouine centre & alentours
    ("Musée de Tataouine", "SITE_TOURISTIQUE", ["CULTUREL"], 32.9300, 10.4520,
     "Le musée de Tataouine présente l'histoire berbère, la culture des ksour et la faune du désert du Grand Erg Oriental.", "museum"),
    ("Souk de Tataouine", "SITE_TOURISTIQUE", ["CULTUREL", "GASTRONOMIQUE"], 32.9333, 10.4500,
     "Le souk de Tataouine est un marché traditionnel où se retrouvent les nomades et les artisans du Dahar.", "attraction"),
    
    # Sud & Oasis
    ("Bir Lahmar", "SITE_TOURISTIQUE", ["CULTUREL", "ECOLOGIQUE"], 33.1833, 10.4500,
     "Bir Lahmar est une oasis du Dahar célèbre pour ses dattes Deglet Nour, ses ksour et ses paysages de palmeraies.", "attraction"),
    ("Remada", "SITE_TOURISTIQUE", ["CULTUREL"], 32.3167, 10.4000,
     "Remada est une ville oasis au sud de Tataouine, porte du désert et base pour explorer le Grand Erg Oriental.", "attraction"),
    
    # Nature & Désert (ECOLOGIQUE / AVENTURE)
    ("Parc National de Jebil", "SITE_TOURISTIQUE", ["ECOLOGIQUE", "AVENTURE"], 32.5000, 10.2000,
     "Le parc national de Jebil est le plus grand parc national de Tunisie, abritant le désert du Grand Erg Oriental, des gazelles et des renards.", "national_park"),
    ("Dunes du Grand Erg Oriental", "SITE_TOURISTIQUE", ["ECOLOGIQUE", "AVENTURE"], 32.3000, 10.5000,
     "Le Grand Erg Oriental est un immense champ de dunes de sable doré s'étendant jusqu'à la frontière libyenne, paradis du saharienisme.", "attraction"),
    ("Oued El Khil", "SITE_TOURISTIQUE", ["ECOLOGIQUE", "AVENTURE"], 32.8500, 10.4000,
     "L'oued El Khil est un canyon désertique offrant des paysages sauvages et des randonnées dans le Dahar.", "canyon"),
    
    # Gastronomie & Hébergement
    ("Restaurant Dar Chenini", "RESTAURANT", ["GASTRONOMIQUE", "CULTUREL"], 32.9200, 10.2700,
     "Le Dar Chenini est un restaurant traditionnel berbère servant la cuisine locale du Dahar dans un cadre authentique.", "restaurant"),
    ("Café Berbère Tataouine", "RESTAURANT", ["GASTRONOMIQUE", "CULTUREL"], 32.9350, 10.4550,
     "Le Café Berbère est une institution de Tataouine où l'on déguste le thé à la menthe et les pâtisseries locales.", "cafe"),
    ("Hôtel Sangho Tataouine", "HEBERGEMENT", ["AVENTURE"], 32.9400, 10.4600,
     "L'hôtel Sangho Tataouine est un établissement de style ksar offrant une immersion dans l'architecture traditionnelle du Sud.", "hotel"),
    ("Auberge de Jeunesse Ksar Ouled Soltane", "HEBERGEMENT", ["CULTUREL", "AVENTURE"], 32.7900, 10.3000,
     "Cette auberge propose un hébergement authentique au cœur du ksar, idéale pour découvrir la vie berbère.", "guest_house"),
]
...
def is_in_region(lat, lon, tags, name):
    ...
    for black in CITY_BLACKLIST:
        if black in city:
            if any(w in name_lower for w in ["tataouine", "chenini", "douiret", "ksar", "ghomrassen", "bir lahmar", "remada", "guermessa", "jebil", "dahar"]):
                continue
            return False
    return True
...
def enrich_images(destinations):
    ...
    for dest in destinations:
        ...
        if not img:
            img = search_commons_image(f"{dest['name']} Tataouine")
        if img:
            dest["image_url"] = img
            count += 1
        time.sleep(0.4)
