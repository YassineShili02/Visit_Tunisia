...
"""
================================================================================
Visit Tunisia — Scraper Tunis (FINAL — 20 spots de qualité)
================================================================================
Combine OSM + fallback manuel de spots touristiques réels du gouvernorat de Tunis.
Exclut Ariana, Ben Arous, Manouba, Nabeul, Bizerte et le reste du pays.
================================================================================
"""
...
# BBOX du gouvernorat de Tunis
# Nord: 36.95 (Gammarth), Sud: 36.65 (sud Tunis)
# Ouest: 10.05 (Bardo/Séjoumi), Est: 10.45 (Cap Carthage/La Goulette)
BBOX = {
    "s": 36.65,
    "w": 10.05,
    "n": 36.95,
...
LAT_MIN, LAT_MAX = 36.60, 37.00
LON_MIN, LON_MAX = 10.00, 10.50
...
CITY_BLACKLIST = [
    ...
    "medenine", "مدنين", "gabes", "قابس", "kebili", "قبلي", "ariana", "أريانة",
    "ben arous", "بن عروس", "manouba", "منوبة", "radès", "رادس", "hammam lif", "حمام الأنف",
    "ezzahra", "الزهراء", "mornag", "المرناقية", "boumhel", "بومهل البساتين"
]
...
# -----------------------------------------------------------------------------
# FALLBACK MANUEL — Spots touristiques réels de Tunis
# -----------------------------------------------------------------------------

MANUAL_SPOTS = [
    # Tunis centre — Médina & Culturel (UNESCO)
    ("Médina de Tunis", "SITE_TOURISTIQUE", ["CULTUREL"], 36.7985, 10.1715,
     "La médina de Tunis est un site du patrimoine mondial de l'UNESCO, célèbre pour ses souks, ses mosquées et ses palais.", "attraction"),
    ("Mosquée Zitouna", "SITE_TOURISTIQUE", ["RELIGIEUX", "CULTUREL"], 36.7967, 10.1714,
     "La Grande Mosquée Zitouna est le plus ancien et plus grand édifice religieux de Tunis, fondé en 732.", "mosque"),
    ("Bab El Bhar", "SITE_TOURISTIQUE", ["CULTUREL"], 36.7991, 10.1802,
     "Bab El Bhar, aussi appelée Porte de France, est l'entrée emblématique de la médina donnant sur la place de la Victoire.", "city_gate"),
    ("Tourbet El Bey", "SITE_TOURISTIQUE", ["CULTUREL"], 36.7970, 10.1680,
     "Le Tourbet El Bey est un mausolée royal de la dynastie des Husseinites, joyau de l'architecture funéraire tunisoise.", "monument"),
    ("Dar Ben Abdallah", "SITE_TOURISTIQUE", ["CULTUREL"], 36.7975, 10.1725,
     "Dar Ben Abdallah est un palais du XVIIIe siècle abritant le musée des Arts et Traditions populaires de la médina.", "museum"),
    
    # Bardo — Culturel
    ("Musée du Bardo", "SITE_TOURISTIQUE", ["CULTUREL"], 36.8098, 10.1345,
     "Le musée national du Bardo est l'un des plus grands musées du Maghreb, célèbre pour ses mosaïques romaines exceptionnelles.", "museum"),
    
    # Carthage — Culturel (UNESCO)
    ("Site Archéologique de Carthage", "SITE_TOURISTIQUE", ["CULTUREL"], 36.8528, 10.3233,
     "Carthage est un site archéologique majeur classé à l'UNESCO, ancienne cité phénicienne et romaine.", "archaeological_site"),
    ("Amphithéâtre de Carthage", "SITE_TOURISTIQUE", ["CULTUREL"], 36.8560, 10.3150,
     "L'amphithéâtre de Carthage est un impressionnant théâtre romain datant du IIe siècle, témoin des jeux de l'époque.", "amphitheatre"),
    ("Thermes d'Antonin", "SITE_TOURISTIQUE", ["CULTUREL"], 36.8450, 10.3250,
     "Les thermes d'Antonin sont les plus grands thermes romains d'Afrique, situés sur la colline de Byrsa à Carthage.", "ruins"),
    ("Cathédrale Saint-Louis de Carthage", "SITE_TOURISTIQUE", ["RELIGIEUX", "CULTUREL"], 36.8530, 10.3200,
     "La cathédrale Saint-Louis de Carthage est un édifice néo-byzantin dominant la colline de Byrsa.", "cathedral"),
    ("Musée de Carthage", "SITE_TOURISTIQUE", ["CULTUREL"], 36.8510, 10.3220,
     "Le musée national de Carthage présente les découvertes archéologiques du site antique.", "museum"),
    
    # Sidi Bou Saïd & environs — Culturel & Balnéaire
    ("Sidi Bou Saïd", "SITE_TOURISTIQUE", ["CULTUREL", "BALNEAIRE"], 36.8670, 10.3417,
     "Sidi Bou Saïd est un village pittoresque aux maisons blanches et aux portes bleues, perché sur une falaise face à la mer.", "attraction"),
    ("Palais Ennejma Ezzahra", "SITE_TOURISTIQUE", ["CULTUREL"], 36.8750, 10.3420,
     "Le palais Ennejma Ezzahra est un palais néo-mauresque magnifique abritant le Centre des Musiques Arabes et Méditerranéennes.", "monument"),
    
    # Balnéaire — Plages & Côtes
    ("Plage de La Marsa", "SITE_TOURISTIQUE", ["BALNEAIRE"], 36.8890, 10.3230,
     "La plage de La Marsa est une station balnéaire chic du nord de Tunis, réputée pour son sable fin et ses eaux claires.", "beach"),
    ("Plage de Gammarth", "SITE_TOURISTIQUE", ["BALNEAIRE"], 36.9167, 10.2833,
     "La plage de Gammarth est une station balnéaire haut de gamme avec des complexes hôteliers et des restaurants.", "beach"),
    ("La Goulette", "SITE_TOURISTIQUE", ["BALNEAIRE", "CULTUREL"], 36.8180, 10.3050,
     "La Goulette est le port de plaisance de Tunis, célèbre pour ses restaurants de poisson et ses fortifications espagnoles.", "attraction"),
    
    # Écologique
    ("Parc du Belvédère", "SITE_TOURISTIQUE", ["ECOLOGIQUE", "CULTUREL"], 36.8260, 10.1790,
     "Le parc du Belvédère est le plus grand jardin public de Tunis, abritant le musée d'Art Moderne et un zoo.", "attraction"),
    
    # Gastronomie & Hébergement
    ("Restaurant Dar El Jeld", "RESTAURANT", ["GASTRONOMIQUE", "CULTUREL"], 36.7980, 10.1700,
     "Dar El Jeld est un restaurant gastronomique de luxe situé dans un palais historique de la médina de Tunis.", "restaurant"),
    ("Café des Délices", "RESTAURANT", ["GASTRONOMIQUE", "CULTUREL"], 36.8675, 10.3420,
     "Le Café des Délices est une institution de Sidi Bou Saïd offrant une vue panoramique sur le golfe de Tunis.", "cafe"),
    ("Hôtel Dar El Makhzen", "HEBERGEMENT", ["CULTUREL"], 36.8000, 10.1750,
     "L'hôtel Dar El Makhzen est un établissement de charme installé dans un palais de la médina.", "hotel"),
    ("Hôtel Laico Tunis", "HEBERGEMENT", ["BALNEAIRE"], 36.8400, 10.2900,
     "L'hôtel Laico Tunis est un complexe hôtelier 5 étoiles situé entre le lac et la mer, proche de Carthage.", "hotel"),
]
...
def is_in_region(lat, lon, tags, name):
    ...
    for black in CITY_BLACKLIST:
        if black in city:
            if any(w in name_lower for w in ["tunis", "carthage", "sidi bou", "la marsa", "gammarth", "le kram", "la goulette", "bardo", "byrsa"]):
                continue
            return False
    return True
...
def enrich_images(destinations):
    ...
    for dest in destinations:
        ...
        if not img:
            img = search_commons_image(f"{dest['name']} Tunis")
        if img:
            dest["image_url"] = img
            count += 1
        time.sleep(0.4)
