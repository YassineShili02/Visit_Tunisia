...
"""
================================================================================
Visit Tunisia — Scraper Tozeur (FINAL — 20 spots de qualité)
================================================================================
Combine OSM + fallback manuel de spots touristiques réels du gouvernorat de Tozeur.
Inclut Nefta, Chebika, Tamerza, Midès. Exclut Gafsa, Kébili, Tataouine et le nord.
================================================================================
"""
...
# BBOX du gouvernorat de Tozeur (Sud-Ouest)
# Nord: 34.40 (Chebika/Tamerza), Sud: 33.50 (Chott El Djerid)
# Ouest: 7.60 (Midès), Est: 8.50 (Chott)
BBOX = {
    "s": 33.50,
    "w": 7.60,
    "n": 34.40,
...
LAT_MIN, LAT_MAX = 33.45, 34.45
LON_MIN, LON_MAX = 7.55, 8.55
...
CITY_BLACKLIST = [
    ...
    "gabes", "قابس", "kebili", "قبلي", "matmata", "مطماطة", "douz", "دوز",
...
# -----------------------------------------------------------------------------
# FALLBACK MANUEL — Spots touristiques réels de Tozeur
# -----------------------------------------------------------------------------

MANUAL_SPOTS = [
    # Tozeur centre — Culturel
    ("Médina de Tozeur", "SITE_TOURISTIQUE", ["CULTUREL"], 33.9197, 8.1336,
     "La médina de Tozeur est célèbre pour son architecture traditionnelle en briques ocre, ses ruelles ombragées et ses souks artisanaux.", "attraction"),
    ("Dar Cheraït", "SITE_TOURISTIQUE", ["CULTUREL"], 33.9180, 8.1400,
     "Le musée Dar Cheraït est un palais reconstitué présentant la vie des notables tozeuriens à travers des collections d'art et d'histoire.", "museum"),
    ("Musée du Sahara", "SITE_TOURISTIQUE", ["CULTUREL"], 33.9200, 8.1350,
     "Le musée du Sahara retrace l'histoire des nomades, des cultures du désert et de la vie traditionnelle dans l'erg du Grand Oriental.", "museum"),
    ("Zaouia de Sidi Brahim", "SITE_TOURISTIQUE", ["RELIGIEUX", "CULTUREL"], 33.9100, 8.1500,
     "La zaouia de Sidi Brahim est un lieu de pèlerinage soufi important, témoignant de la spiritualité profonde du sud tunisien.", "mosque"),
    ("Mosquée Sidi Bou Helal", "SITE_TOURISTIQUE", ["RELIGIEUX", "CULTUREL"], 33.9210, 8.1320,
     "La mosquée Sidi Bou Helal est un édifice religieux historique au cœur de la médina de Tozeur.", "mosque"),
    ("Mosquée Sidi Ali Belkacem", "SITE_TOURISTIQUE", ["RELIGIEUX"], 33.9185, 8.1310,
     "La mosquée Sidi Ali Belkacem est un monument religieux emblématique de l'architecture traditionnelle tozeurienne.", "mosque"),

    # Désert & Nature — Écologique / Aventure
    ("Chott El Djerid", "SITE_TOURISTIQUE", ["ECOLOGIQUE", "AVENTURE"], 33.7000, 8.2667,
     "Le Chott El Djerid est un vaste lac salé aux reflets irisés, créant des mirages spectaculaires au cœur du désert.", "wetland"),
    ("Palmeraie de Tozeur", "SITE_TOURISTIQUE", ["ECOLOGIQUE"], 33.9250, 8.1450,
     "La palmeraie de Tozeur compte plus de 400 000 palmiers dattiers, offrant des promenades à dos de dromadaire dans un écrin de verdure.", "nature_reserve"),
    ("Eden Palm", "SITE_TOURISTIQUE", ["ECOLOGIQUE", "CULTUREL"], 33.9220, 8.1480,
     "Eden Palm est un parc écologique dédié à la culture du palmier dattier, à la botanique du désert et aux traditions oasisiennes.", "attraction"),
    ("Ong Jmal", "SITE_TOURISTIQUE", ["AVENTURE", "ECOLOGIQUE"], 33.8167, 7.7667,
     "Ong Jmal, le chameau de pierre, est une formation rocheuse emblématique du désert de Tozeur, prisée des amateurs de sahara trekking.", "attraction"),

    # Montagnes de l'Atlas — Aventure / Écologique
    ("Chebika", "SITE_TOURISTIQUE", ["AVENTURE", "ECOLOGIQUE"], 34.2833, 7.9333,
     "Chebika est un village de montagne aux sources naturelles et cascades, offrant des randonnées spectaculaires dans l'Atlas tunisien.", "attraction"),
    ("Tamerza", "SITE_TOURISTIQUE", ["AVENTURE", "ECOLOGIQUE"], 34.3167, 7.8333,
     "Tamerza est le plus grand canyon de Tunisie, célèbre pour sa cascade, ses oasis cachées et ses paysages de l'Atlas.", "canyon"),
    ("Midès", "SITE_TOURISTIQUE", ["AVENTURE", "ECOLOGIQUE"], 34.2333, 7.7833,
     "Midès est un village perché sur des falaises dominant un canyon vertigineux, à la frontière algérienne.", "viewpoint"),

    # Nefta & alentours
    ("Corbeille de Nefta", "SITE_TOURISTIQUE", ["ECOLOGIQUE", "CULTUREL"], 33.8733, 7.8833,
     "La Corbeille de Nefta est un dépression naturelle couverte de palmiers, considérée comme l'un des plus beaux sites oasisiens de Tunisie.", "attraction"),
    ("Mos Espa", "SITE_TOURISTIQUE", ["CULTUREL", "AVENTURE"], 33.9946, 7.8444,
     "Mos Espa est un village de décors de Star Wars préservé dans le désert, devenu un site touristique incontournable pour les fans et les curieux.", "attraction"),

    # Gastronomie & Hébergement
    ("Restaurant Le Petit Prince", "RESTAURANT", ["GASTRONOMIQUE"], 33.9190, 8.1340,
     "Le Petit Prince est un restaurant réputé de Tozeur spécialisé dans la cuisine du Sud : couscous aux dattes, méchoui et plats berbères.", "restaurant"),
    ("Café Berbère Tozeur", "RESTAURANT", ["GASTRONOMIQUE", "CULTUREL"], 33.9180, 8.1330,
     "Le Café Berbère est un établissement traditionnel de la médina où l'on déguste le thé à la menthe et les pâtisseries aux dattes.", "cafe"),
    ("Restaurant 7émiss", "RESTAURANT", ["GASTRONOMIQUE"], 33.9200, 8.1360,
     "Le 7émiss est un restaurant gastronomique tozeurien réputé pour sa cuisine locale raffinée et son ambiance sahélienne.", "restaurant"),
    ("Hôtel Ksar Rouge", "HEBERGEMENT", ["BALNEAIRE"], 33.9170, 8.1420,
     "Le Ksar Rouge est un hôtel de charme en bordure de palmeraie avec piscine et architecture traditionnelle tozeurienne.", "hotel"),
    ("Hôtel Ras El Ain Tozeur", "HEBERGEMENT", ["BALNEAIRE"], 33.9160, 8.1380,
     "L'hôtel Ras El Ain est un établissement 4 étoiles entouré de verdure, idéal pour un séjour oasisien de qualité.", "hotel"),
]
...
def is_in_region(lat, lon, tags, name):
    ...
    for black in CITY_BLACKLIST:
        if black in city:
            if any(w in name_lower for w in ["tozeur", "nefta", "chebika", "tamerza", "mides", "midès", "ong jmal", "chott", "mos espa", "dar cheraït", "ksar"]):
                continue
            return False
    return True
...
def enrich_images(destinations):
    ...
    for dest in destinations:
        ...
        if not img:
            img = search_commons_image(f"{dest['name']} Tozeur")
        if img:
            dest["image_url"] = img
            count += 1
        time.sleep(0.4)
